...
void shell_ls(void) {
    ...
    delay(2000000000);
    fs_list();  // fs_list ke andar bhi delays honge
}
...
void shell_ps(void) {
    print_string("\n=== Process Table ===\n");
    delay(2000000000);
    print_process_table();  // print_process_table ke andar bhi delays honge
}

void shell_sched(void) {
    print_string("\n=== ML Scheduler Stats ===\n");
    delay(2000000);
    print_ml_scheduler_stats();  // print_ml_scheduler_stats ke andar bhi delays honge
}
